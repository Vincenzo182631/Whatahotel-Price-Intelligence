...
Every tunable weight and threshold in the MVP, in one place. Covers the proposal's requirement to _"clearly identify which weights and thresholds should be configurable so we can calibrate them later."_
